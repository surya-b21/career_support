<template>
	...
	<div class="p-20 flex flex-col items-center">
		<p class="text-4xl leading-15 font-semibold text-center">Confused about Choosing the Right Service for Your Career Center Needs? Don't Worry!</p>
		<p class="text-lg text-center text-[#4B4B4B] my-5">In addition to supporting students individually, Career Support helps schools create a professional career center. All student and alumni data can be monitored and it makes it easier for them to connect to job and internship opportunities from partner companies.</p>
