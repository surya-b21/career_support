	...
	<!-- Section 7 -->
	 <div class="w-full bg-[#EDF3F9] p-5 md:p-20 flex flex-col items-center">
		...
		<div class="flex items-center gap-x-2 md:gap-x-5">
			...
			<div class="flex items-center justify-center mt-5 md:hidden">
				<div class="custom-card w-[250px] h-[265px]" :key="currentSlide">
			...
			<div class="hidden md:flex items-center justify-center gap-x-5 mt-5">
				<div class="custom-card w-[350px] h-[352px]" v-for="index in [0, 1, 2]" :key="currentSlide + index">
			...
			<div class="custom-card w-[350px] md:h-[452px]">
				...
				<div>
					<div class="flex items-center text-[#818C9F] mb-3">
						...
						<span class="ml-2">Monday, 20 January 2026</span>
					</div>
					<div class="flex items-center text-[#818C9F] mb-3">
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
							<rect width="24" height="24" fill="none" />
						...
						<span class="ml-2">10:00 - 11:00</span>
					</div>
				</div>

				<button class="button sold-out mt-5">
					<span>Sold Out</span>
				</button>
			</div>
			<div class="custom-card w-[350px] md:h-[452px]">
...
const section7CardsContent = reactive([
	{"title": "SMK YAJ Depok - Job Fair 2024", "img": new URL(`../assets/images/section7/8.png`, import.meta.url).href},
	{"title": "SMKN 4 Jakarta - Job & Edu Fair 2024", "img": new URL(`../assets/images/section7/1.png`, import.meta.url).href},
	{"title": "SMKN 33 Jakarta - Exploring Tourism Careers", "img": new URL(`../assets/images/section7/2.png`, import.meta.url).href},
	{"title": "SMKN 69 Jakarta - Job Fair Membara 2024", "img": new URL(`../assets/images/section7/3.png`, import.meta.url).href},
	{"title": "SMKS Assalam Depok - Bursa Kerja 2024", "img": new URL(`../assets/images/section7/4.png`, import.meta.url).href},
	{"title": "Universitas Majalengka - UNMA Career Expo 2024", "img": new URL(`../assets/images/section7/5.png`, import.meta.url).href},
	{"title": "SMK Islam PB Soedirman 2 - Career Day 2024", "img": new URL(`../assets/images/section7/6.png`, import.meta.url).href},
	{"title": "SMK Telkom Bandung - Job Fair 2024", "img": new URL(`../assets/images/section7/7.png`, import.meta.url).href},
])
...
.custom-card .button.sold-out {
	border: 1px solid #D8E4ED;
	background-color: white;
}

.custom-card .button.sold-out:hover {
	background-color: #F0F4F8;
}

.custom-card .button.join {
